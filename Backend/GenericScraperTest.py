import GenericScraperDemo as scraper
...
if __name__ == "__main__":
    ...
    for url in test_urls:
        print(f"Testing URL: {scraper.get_domain(url)}")
        result = scraper.get_scraping_data(url)
        #print("result:", result, "count:", len(result.get("images", [])))
        print("count:", len(result.get("images", [])))